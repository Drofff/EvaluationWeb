<html>
<head>
    <title>Evaluation Web - Test Result</title>
...
<div class="ui segment grid">
    ...
    <div style="margin-left : 45%; margin-top: 7%; margin-bottom : 5%;">
        <h1 class="ui header">Your result is:</h1>
        <div class="ui statistics" style="margin-left : 20%;">
            <div class="<#if level == 'Low'>red</#if><#if level == 'Middle'>yellow</#if><#if level == 'High'>green</#if> statistic">
                <div class="value">
                    ${grade}
                </div>
                <div class="label">
